...
case 'secret':if(args[0]==='bar'){doSecretBar();}else{tp('secret: unknown argument. Try harder.','red');}break;
...
function doSecretBar(){tp('[ACCESSING HIDDEN CHANNEL...]','green');setTimeout(function(){tp('[SIGNAL LOCKED]','green');},500);setTimeout(function(){tC('\u2588\u2588\u2588 SECRET BAR \u2588\u2588\u2588','#ff00ff');tp('The resistance has a private channel:','dim');tH('<span style="font-size:14px">\u25B6 <a href="https://matrix.to/#/!gMycVwxQenbMpjTtIp:matrix.org?via=matrix.org" target="_blank" rel="noopener" style="color:#00ccff;text-decoration:underline;text-shadow:0 0 8px #00ccff">Join the Matrix Chat</a></span>');tp('Open source \u2022 decentralized \u2022 encrypted','dim');},1000);}
